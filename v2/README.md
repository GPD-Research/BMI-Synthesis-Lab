...
audit is in `ledger_v1_audit.md`; the negative-results record is `../RETRACTED.md`.
...
| 2 | Action | `01_action.md`: signs, factors, Fork 1 warped geometry, one $V(\Phi)$ form, GHY terms | ledger ≤ 8 rows, 0 free functions | |
